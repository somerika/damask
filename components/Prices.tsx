...
const content: Record<
  'en' | 'fi',
  { eyebrow: string; h2: string; disclaimer: string; categories: Cat[] }
> = {
  en: {
    eyebrow: 'Pricing',
    h2: 'Services & Pricing.',
    ...
    disclaimer:
      'Kaikki hinnat sisältävät ALV:n. Walk-in-asiakkaat tervetulleita — väripalveluihin suositellaan ajanvarausta.',
    categories: [
      {
        title: 'Hiukset',
        items: [
          { label: 'Hiustenpesut', price: '€5' },
          { label: 'Hiustenleikkaus', price: '€25' },
          { label: 'Tyylileikkaus', price: 'alkaen €30' },
          { label: 'Hiusten värjäys', price: 'alkaen €40' },
          { label: 'Raidat', price: 'alkaen €40' },
          { label: 'Hiusten suoristus', price: 'alkaen €40' },
          { label: 'Hiustatuointi', price: 'alkaen €15' },
          { label: 'Lapset (alle 12 v.)', price: '€20' },
        ],
      },
      {
        title: 'Parta & Ajelu',
        items: [
          { label: 'Koneajelu', price: '€10' },
          { label: 'Teräajelu', price: '€15' },
          { label: 'Parranmuotoilu', price: '€15' },
        ],
      },
      {
        title: 'Ihonhoito',
        items: [
          { label: 'Käsin kasvohoito (20 min)', price: '€20' },
          { label: 'Koneellinen kasvohoito (60 min)', price: '€50' },
        ],
      },
      {
        title: 'Karvanpoisto',
        items: [
          { label: 'Vahapoistohoito', price: 'alkaen €10' },
          { label: 'Lankaepilaatio', price: '€10' },
        ],
      },
      {
        title: 'Muut',
        items: [{ label: 'Korvanpuhdistus', price: '€15' }],
      },
    ],
  },
}
    ...
    <section id="prices" ref={ref} className="bg-surface border-t border-border">
      ...
      >
        ...
        >
          ...
          <p className="text-muted text-sm font-light leading-[1.7] max-w-[48ch]">{t.disclaimer}</p>
        </motion.div>
