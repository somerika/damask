    ...
    <section id="about" ref={ref} className="bg-surface border-t border-border">
      ...
      >
        ...
        <div className="flex items-center gap-3 mb-8">
          ...
          <span className="text-accent text-[0.6875rem] tracking-[0.3em] uppercase">Our Story</span>
        </div>
          ...
          <div>
            ...
            <div className="max-w-[54ch]">
              ...
              <p className="text-muted text-base leading-[1.85] font-light">
                ...
                metropolitan area. The standard has stayed the same: expert hands, patient craft,
                and genuine care for every person who sits in the chair.
              </p>
            </div>
          </div>
